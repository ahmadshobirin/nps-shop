...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-info">
            ...
            <form action="{{ route('kategori-produk.update',$kategoriProuduk->id) }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Nama Kategori..." maxlength="30" value="{{$kategoriProuduk->name}}">
                    </div>
                </div>
